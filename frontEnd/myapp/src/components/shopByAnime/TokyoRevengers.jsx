...
import '../shopByAnime/TokyoRevengers.css';
...
const TokyoRevengers = () => {
    ...
    const [tokyoRevengers,setTokyoRevengers] = useState([])
    ...
    useEffect(() => {
        handleTokyoRevengers()
    })

    function handleTokyoRevengers(){
        setTokyoRevengers(products.filter((data) => (data.anime === "tokyo revengers")))
    }

      console.log("Naruto",tokyoRevengers)
    return (
        <div className="main1H">
            ...
            <div className="center1N">
                ...
                <div className='narutoTitle'><h1>TOKYO REVENGERS</h1></div>
                <div className="narutoTitleImage">
                        <Image height='100%' width='100%' src='https://otakukulture.in/wp-content/uploads/2023/09/Tokyo-revengers.png'></Image>
                </div>

                <div style={{display:'flex',justifyContent:'Left',alignItems:'Left',paddingLeft:'150px',marginTop:'30px'}} className='homeNaruto'>
                    <Link to={'/'}><p>Home</p></Link> 
                <p style={{marginLeft:'20px',marginRight:'20px'}}>/</p> <Link to={'/Naruto'}><p>Demon Slayer</p></Link></div>
                ...
                <div className="narutoProducts">
                    ...
                    <div className="productsRight">
                        {
                            tokyoRevengers.map((item,cardIndex) => (
                                <Link>
                                <Card
