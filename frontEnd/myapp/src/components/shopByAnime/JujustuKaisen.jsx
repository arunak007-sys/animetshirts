...
const JujustuKaisen = () => {
    ...
    const [JujustuKaisen,setJujustuKaisen] = useState([])
    ...
    function handleJujustuKaisen(){
        setJujustuKaisen(products.filter((data) => (data.anime === "jujustu kaisen")))
    }


    //   useEffect(() => {
    //     const storedNaruto = JSON.parse(localStorage.getItem('naruto'));
    //     if (storedNaruto) {
    //         setDemonSlayer(storedNaruto);
    //     } else {
    //         fetchProducts();
    //     }
    // }, []);
    ...
    // const fetchProducts = async () => {
    //     const response = await axios.get("http://localhost:5000/Product/products");
    //     const narutoProducts = response.data.filter(prod => prod.anime === "Naruto");
    //     setDemonSlayer(narutoProducts);
    //     localStorage.setItem('naruto', JSON.stringify(narutoProducts));
    // }
      console.log("Naruto",JujustuKaisen)
    return (
        <div className="main1H">
            ...
            <div className="center1N">
                ...
                <div className='narutoTitle'><h1>JUJUSTU KAISEN</h1></div>
                <div className="narutoTitleImage">
                        <Image height='100%' width='100%' src='https://otakukulture.in/wp-content/uploads/2023/09/JJK.png'></Image>
                </div>

                <div style={{display:'flex',justifyContent:'Left',alignItems:'Left',paddingLeft:'150px',marginTop:'30px'}} className='homeNaruto'>
                    <Link to={'/'}><p>Home</p></Link> 
                <p style={{marginLeft:'20px',marginRight:'20px'}}>/</p> <Link to={'/Naruto'}><p>Jujustu Kaisen</p></Link></div>
                ...
                <div className="narutoProducts">
                    ...
                    <div className="productsLeft">
                        ...
                        <div className="productCategory">
                            <div  className='checkBoxDiv' ><input type="checkbox" className='checkBox'/><label>T - Shirt</label></div>
                            <div className='checkBoxDiv'><input type="checkbox" className='checkBox'/><label>Hoodies</label></div>
                            <div  className='checkBoxDiv'><input type="checkbox" className='checkBox'/><label>Jacket</label></div>
                            <div  className='checkBoxDiv'><input type="checkbox" className='checkBox'/><label>Sweatshirt</label></div>
                            <div  className='checkBoxDiv'><input type="checkbox" className='checkBox'/><label>Combo</label></div>
                            <div  className='checkBoxDiv'><input type="checkbox" className='checkBox'/><label>Tank Top</label></div>
                            <div  className='checkBoxDiv'><input type="checkbox" className='checkBox'/><label>Combo</label></div>
                        </div>
                    ...
                    <div className="productsRight">
                        {
                            JujustuKaisen.map((item,cardIndex) => (
                                <Link>
                                <Card
