...
import '../shopByAnime/DemonSlayer.css';
...
const DemonSlayer = () => {
    ...
    const [demonSlayer,setDemonSlayer] = useState([])
    ...
    function handleDemonSlayer(){
        setDemonSlayer(products.filter((data) => (data.anime === "demon slayer")))
        fetchProducts()
    }


    
      console.log("Naruto",demonSlayer)
    return (
        <div className="main1H">
            ...
            <div className="center1N">
                ...
                <div className='narutoTitle'><h1>DEMON SLAYER</h1></div>
                <div className="narutoTitleImage">
                        <Image height='100%' width='100%' src='https://otakukulture.in/wp-content/uploads/2023/09/Demon-Slayer.png'></Image>
                </div>
                ...
                <div className="narutoProducts">
                    ...
                    <div className="productsRight">
                        {
                            demonSlayer.map((item,cardIndex) => (
                                <Link>
                                <Card
