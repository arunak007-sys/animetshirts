...
import '../soldierCollection/SoldierCollection.css'
...
const SoldierCollection = () => {
    ...
    const getNaruto = async () => {
        try{
            const filter = (products.filter((data) => data.category === "t-shirt"))
            setNaruto(filter)
        }
        catch (err) {
            console.log(err)
    ...
    return (
        <div className="main1H">
            ...
            <div className="center1N">
                ...
                <div className='narutoTitle'><h1>Soldier Collection</h1></div>
                ...
                <div style={{ display: 'flex', justifyContent: 'Left', alignItems: 'Left', paddingLeft: '150px', marginTop: '30px' }} className='homeNaruto'>
                    ...
                    <p style={{ marginLeft: '20px', marginRight: '20px' }}>/</p> <Link to={'/NewLaunch'}><p>Soldier Collection</p></Link></div>
...
export default SoldierCollection;
