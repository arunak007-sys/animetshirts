...
import '../ShopByProducts/ShopByProducts.css'
...
const ShopByProducts = () => {
    ...
    const cat = async () => {
        try{
            const nar = 'naruto'
            const response = await axios.post(`http://localhost:5000/Users/getCategory/${category}`)
    ...
    console.log("Category  da",productData,category);
    ...
    const filteredProducts = productData.filter(product => {
        if (productTypeFilters.length > 0 && !productTypeFilters.includes(product.anime)) {
            return false;
        }
    ...
    return (
        <div className="main1H">
                        ...
                        <Navbar expand="lg" variant="dark" style={{ width: '100%', height: '100%' }}>
                            ...
                            <Navbar.Collapse id="basic-navbar-nav">
                                <Nav className="mr-auto" style={{
                                    ...
                                    <Nav.Link onClick={()=>nav(`/ProductsDisplay/${'combo'}`)}><p className="headerTitles1H">COMBO</p></Nav.Link>
            ...
            <div className="center1N">
                ...
                <div className='narutoTitle'><h1>{category.toUpperCase()}</h1></div>
                ...
                <div style={{ display: 'flex', justifyContent: 'Left', alignItems: 'Left', paddingLeft: '150px', marginTop: '30px' }} className='homeNaruto'>
                    ...
                    <p style={{ marginLeft: '20px', marginRight: '20px' }}>/</p> <Link to={'/Naruto'}><p>{category}</p></Link></div>
                ...
                <div className="narutoProducts">
                    ...
                    <div className="productsLeft">
                        ...
                        <div className="categoryHead1" style={{ display: 'flex', alignItems: 'left', justifyContent: 'left', marginTop: '20px' }}><p>ANIME TYPE</p></div>
                        
                        <div className="productCategory">
                            <div className='checkBoxDiv'><input type="checkbox" checked={checkboxes[0]}  onChange={() => filterProductType("Naruto") || handleCheckboxChange(0)} className='checkBox' /><label>Naruto</label></div>
                            <div className='checkBoxDiv'><input type="checkbox" checked={checkboxes[1]}  onChange={() => filterProductType("one piece") || handleCheckboxChange(1)} className='checkBox' /><label>One Piece</label></div>
                            <div className='checkBoxDiv'><input type="checkbox" checked={checkboxes[2]}  onChange={() => filterProductType("demon slayer") || handleCheckboxChange(2)} className='checkBox' /><label>Demon Salyer</label></div>
                            <div className='checkBoxDiv'><input type="checkbox" checked={checkboxes[3]} onChange={() => filterProductType("attak on titan") || handleCheckboxChange(3)} className='checkBox' /><label>Attack On Titan</label></div>
                            <div className='checkBoxDiv'><input type="checkbox" checked={checkboxes[4]} onChange={() => filterProductType("tokyo revengers") || handleCheckboxChange(4)} className='checkBox' /><label>Tokyo Revengers</label></div>
                            <div className='checkBoxDiv'><input type="checkbox" checked={checkboxes[5]} onChange={() => filterProductType("dragon ball") || handleCheckboxChange(5)} className='checkBox' /><label>Dragon Ball</label></div>
                            <div className='checkBoxDiv'><input type="checkbox" checked={checkboxes[6]} onChange={() => filterProductType("jujustu kaisen") || handleCheckboxChange(6)} className='checkBox' /><label>Jujustu Kaisen</label></div>
                        </div>
