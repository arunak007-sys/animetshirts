    ...
    const cat = async () => {
        try{
            if(productTypeFilters === ''){
                const response = await axios.post(`http://localhost:5000/Users/getCategory/${productTypeFilters}`)
            setProductData(response.data)
            }
            else{
                const response = await axios.post(`http://localhost:5000/Users/getCategory/${"oversize"}`)
            setProductData(response.data)
            }
        }
        catch (err) {
...
const filterProductType = async (type) => {
    ...
    console.log(" porducttypefilters",productTypeFilters)
